...
import { EncryptionKey as GroupKey } from 'streamr-client';
import { Lifecycle, scoped } from 'tsyringe';

import { StorageNodeAssignmentEvent } from '../registry/LogStoreRegistry';
...
export class StreamrClientEventEmitter extends ObservableEventEmitter<
	StreamrClientEvents & InternalEvents
> {}
