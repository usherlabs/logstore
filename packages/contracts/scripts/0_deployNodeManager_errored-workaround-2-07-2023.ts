/**
 * Deployment to mainnet fails intermittently....
 * Details here: https://www.notion.so/usherlabs/Log-Store-Smart-Contract-Deployment-c405641257244c358db0ed541826426a?pvs=4
 *
 * This script is a hack to get contracts up.
 */
...
async function main() {
	...
	const nodeManagerContract = await nodeManagerArtifact.attach(
		'0x7AcA5FbE68664cf27f395c566CC73f72d1761a09'
	);
	const nodeManagerAddress = nodeManagerContract.address;
	const tokenManagerContract = await tokenManager.attach(
		'0xAE6A9793b7CCD9e1F39064190CCFEcdeC377397b'
	);
	const tokenManagerAddress = tokenManagerContract.address;
	const queryManagerAddress = '0x27012966b1F6CFD4934631Fd22f5F07F7dE6a999';
	const storeManagerAddress = '0x697694AA5F4B50DE484029E0911759857e619130';
	...
	// await lib.deployed();
	const LibContract = Lib.attach('0xeb750e3284ae96b80ac91fccf44f441b53fa1b6d');
	// // deploy contract
	const reportManager = await hre.ethers.getContractFactory(
		'LogStoreReportManager',
		{
			libraries: {
				VerifySignature: LibContract.address,
			},
		}
	);
	...
	const reportManagerContract = reportManager.attach(
		'0x9271C1840E626596f709DaB166F534cE2c5a0e27'
	);
	const reportManagerAddress = reportManagerContract.address;
	...
	console.log(`LogStoreNodeManager registered QueryManager`, {
		nodeManagerAddress,
		queryManagerAddress,
	});
	...
	console.log(`LogStoreNodeManager registered StoreManager`, {
		nodeManagerAddress,
		storeManagerAddress,
	});
	...
	console.log(`LogStoreNodeManager registered ReportManager`, {
		nodeManagerAddress,
		storeManagerAddress,
	});
