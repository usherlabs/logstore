...
describe('Logstore', function () {
	...
	// describe('Admin can Add and Remove nodes', () => {
	...
	// describe('Admin can whitelist and reject whitelisted nodes', () => {
	// 	it('Admin can whitelistApproveNode', async function () {
	...
	// 	});
	// 	it('Admin can whitelistRejectNode', async function () {
	...
	// 	});
	// it('Admin can kickNode', async function () {
	// 	const nodeAddress = NODE_MANAGER.INITIAL_NODES[0];
	...
	// it('StakeAmount - Stake', async function () {
	// 	const stakeAmount = getDecimalBN(1);
	// 	// stake amount and validate staked
	// 	await nodeManagerContract
	// 		.connect(whitelistedNodeSigner)
