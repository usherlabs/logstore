...
<<<<<<< HEAD
		...
		'captureBundle(string[],uint256[],uint256[])': FunctionFragment;
=======
...
>>>>>>> feature/broker
	...
	encodeFunctionData(
<<<<<<< HEAD
		functionFragment: 'captureBundle',
		values: [
			PromiseOrValue<string>[],
			PromiseOrValue<BigNumberish>[],
			PromiseOrValue<BigNumberish>[]
...
<<<<<<< HEAD
		'StoreUpdated(string,bool,uint256,address)': EventFragment;
=======
...
<<<<<<< HEAD
		captureBundle(
			streamIds: PromiseOrValue<string>[],
...
<<<<<<< HEAD
		'StoreUpdated(string,bool,uint256,address)'(
			store?: null,
			isNew?: null,
			amount?: null,
			updatedBy?: null
