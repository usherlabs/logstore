...
export function LogStore(base: any, clientConfig: LogStoreClientConfig = {}) {
	class LogStoreClient extends base {
		readonly logStoreRegistry: LogStoreRegistry;
		readonly logStoreQueries: Queries;
		readonly logStoreClientEventEmitter: LogStoreClientEventEmitter;
		...
		constructor(
			...
			this.logStoreClientEventEmitter =
				container.resolve<LogStoreClientEventEmitter>(
	...
	return new LogStoreClient(clientConfig);
}
